...
/**
 * Obiekt dzielący strumień znaków (Reader) na kawałki w postaci obiektów klasy String.
 * 
 * 
 ...
 * 
 * 
 * @param reader Reader przekazujący tekst zawierający znaczniki TMX
 * @param languageCode Język naturalny w jakim zapisany jest tekst. Kod dwuliterowy wg. normy ISO 639.
 */
    public void initialize(Reader reader, String languageCode);
    //public void initialize(pl.poleng.schema.Reader rerader, String languageCode);
/**
