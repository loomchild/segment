...
public abstract class AbstractSrxTextIteratorTest {
	...
	public void testSimpleSplit() {
		performTest(SIMPLE_RESULT, SIMPLE_TEXT, 
				SIMPLE_DOCUMENT, SIMPLE_LANGUAGE);
	}
	...
	public void testEmptyText() {
		performTest(EMPTY_RESULT, EMPTY_TEXT, 
				EMPTY_DOCUMENT, EMPTY_LANGUAGE);
	}

	
	public static final String ALTERNATIVE_RULE_TEXT = 
	...
	public void testAlternativeRuleSplit() {
		performTest(ALTERNATIVE_RULE_RESULT, ALTERNATIVE_RULE_TEXT, 
				ALTERNATIVE_RULE_DOCUMENT, ALTERNATIVE_RULE_LANGUAGE);
	}
	

	public static final String OVERLAPPING_RULES_TEXT = 
	...
	public void testOverlappingRulesSplit() {
		performTest(OVERLAPPING_RULES_RESULT, OVERLAPPING_RULES_TEXT, 
				OVERLAPPING_RULES_DOCUMENT, OVERLAPPING_RULES_LANGUAGE);
	}


	public static final String INTERLACED_RULES_TEXT = 
		"a? b? a. b. c. d.";
	...
	public void testInterlacedRulesSplit() throws IOException {
		performTest(INTERLACED_RULES_RESULT, INTERLACED_RULES_TEXT, 
				INTERLACED_RULES_DOCUMENT, INTERLACED_RULES_LANGUAGE);
	}


	public static final String NO_BREAKING_RULES_TEXT = 
		"abcab";
	...
	public void testNoBreakingRules() {
		performTest(NO_BREAKING_RULES_RESULT, NO_BREAKING_RULES_TEXT, 
				NO_BREAKING_RULES_DOCUMENT, NO_BREAKING_RULES_LANGUAGE);
	}


	public static final String INFINITE_NEGATIVE_RULE_TEXT = 
		"Abc 99. Def. Xyz.";
	...
	public void testInfiniteNegativeRule() {
		performTest(INFINITE_NEGATIVE_RULE_RESULT, INFINITE_NEGATIVE_RULE_TEXT, 
				INFINITE_NEGATIVE_RULE_DOCUMENT, INFINITE_NEGATIVE_RULE_LANGUAGE);
	}


	public static final String ONLY_BREAKING_RULES_TEXT = 
		"Abc 99. Def. Xyz.";
	...
	public void testOnlyBreakingRules() {
		performTest(ONLY_BREAKING_RULES_RESULT, ONLY_BREAKING_RULES_TEXT, 
				 ONLY_BREAKING_RULES_DOCUMENT, ONLY_BREAKING_RULES_LANGUAGE);
	}

	
	public static final String BREAK_AT_THE_END_TEXT = 
		"a.";
	...
	public void testBreakAtTheEndOfText() {
		performTest(BREAK_AT_THE_END_RESULT, BREAK_AT_THE_END_TEXT, 
				BREAK_AT_THE_END_DOCUMENT, BREAK_AT_THE_END_LANGUAGE);
	}
	
	
	public static final String EMPTY_NON_BREAKING_RULE_TEXT = 
		"a. b. c";
	...
	public void testEmptyNonBreakingRule() {
		performTest(EMPTY_NON_BREAKING_RULE_RESULT, EMPTY_NON_BREAKING_RULE_TEXT, 
				EMPTY_NON_BREAKING_RULE_DOCUMENT, EMPTY_NON_BREAKING_RULE_LANGUAGE);
	}
	
	
	public static final String EMPTY_BREAKING_RULE_TEXT = 
		"a bc";
	...
	public void testEmptyBreakingRule() {
		performTest(EMPTY_BREAKING_RULE_RESULT, EMPTY_BREAKING_RULE_TEXT, 
	...
	private void performTest(String[] expectedResult, String text, 
			SrxDocument document, String languageCode) {
