...
public class MergedPatternTextIteratorReaderTest extends AbstractSrxTextIteratorTest {
	...
	protected TextIterator getTextIterator(String text,
		...
		return new MergedPatternTextIterator(document, languageCode, charSequence);
	}
